...
import { formatCurrency, formatDateTime, formatDate, ORDER_STATUS_MAP, PAYMENT_STATUS_MAP, PAYMENT_METHOD_MAP, DELIVERY_TYPE_MAP } from '@/lib/utils'
...
export default function OrderDetailPage() {
  ...
  if (!order) {
    return (
      <DashboardLayout title="Đơn hàng không tồn tại">
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-6">
          ...
          <div className="flex gap-2">
            ...
            <Button className="bg-rose-600 hover:bg-rose-700" size="sm">Lưu thay đổi</Button>
          </div>
        </div>
